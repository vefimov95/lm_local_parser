package ru.leroymerlin.finparser.configuration;
...
public class AppConfig {
    ...
    public SwiftCurrency swiftCurrency() {
        return new SwiftCurrency();
    }

    @Bean
    @ConfigurationProperties(prefix = "path")
    public SwiftEntityTransaction swiftProperties() {
        return new SwiftEntityTransaction();
    }
